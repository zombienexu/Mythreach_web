...
const DEFS: EnemyDef[] = [
  // ── Pack minions: one per zone ──────────────────────────────────────
  // Individually feeble; they exist to flank something meaner. Tuned so a
  // pair of them plus a back-row mob lands near one solo normal's DPS.
  {
    id: 'gravel-skitterling',
    name: 'Gravel Skitterling',
    intro: 'Gravel Skitterlings pour out of the cracks.',
    level: 1,
    rank: 'normal',
    hp: 45,
    swingTicks: 40,
    ...
    goldMax: 4,
    dropPct: 6,
    portrait: { family: 'spider', hue: 70 },
    mechanics: [],
  },
  {
    id: 'mire-whelp',
    name: 'Mire Whelp',
    intro: 'A Mire Whelp wriggles free of the muck.',
    level: 4,
    rank: 'normal',
    hp: 85,
    swingTicks: 38,
    ...
    goldMax: 7,
    dropPct: 6,
    portrait: { family: 'beast', hue: 160 },
    mechanics: [],
  },
  {
    id: 'harpy-fledgling',
    name: 'Harpy Fledgling',
    intro: 'A Harpy Fledgling tumbles from the nest, all talons.',
    level: 7,
    rank: 'normal',
    hp: 150,
    swingTicks: 36,
    ...
    goldMax: 10,
    dropPct: 6,
    portrait: { family: 'beast', hue: 225 },
    mechanics: [],
  },
  {
    id: 'ember-imp',
    name: 'Ember Imp',
    intro: 'An Ember Imp cackles somewhere at knee height.',
    level: 10,
    rank: 'normal',
    hp: 220,
    swingTicks: 38,
    ...
    goldMax: 13,
    dropPct: 6,
    portrait: { family: 'wisp', hue: 45 },
    mechanics: [],
  },
  {
    id: 'void-mite',
    name: 'Void Mite',
    intro: 'A Void Mite skitters in on too many axes.',
    level: 13,
    rank: 'normal',
    hp: 270,
    swingTicks: 36,
  ...
  {
    // Stat-clone of the Mossback Boar — a new face, not a new threat.
    id: 'root-creeper',
    name: 'Root Creeper',
    intro: 'A Root Creeper unknots itself from the wall.',
    level: 2,
    rank: 'normal',
    hp: 100,
    swingTicks: 34,
    ...
    goldMax: 10,
    dropPct: 16,
    portrait: { family: 'spider', hue: 120 },
    mechanics: [],
  },
  {
    id: 'rockmaw-bruiser',
  ...
  {
    // Stat-clone of the Bog Lurker.
    id: 'fen-shade',
    name: 'Fen Shade',
    intro: 'A Fen Shade gathers itself out of the mist.',
    level: 5,
    rank: 'normal',
    hp: 200,
    swingTicks: 48,
    ...
    goldMax: 15,
    dropPct: 16,
    portrait: { family: 'revenant', hue: 190 },
    mechanics: [],
  },
  {
    id: 'mirefiend-brute',
  ...
  {
    // Stat-clone of the Harpy Skyrender.
    id: 'cliff-stalker',
    name: 'Cliff Stalker',
    intro: 'A Cliff Stalker pours down the rock face.',
    level: 7,
    rank: 'normal',
    hp: 280,
    swingTicks: 32,
  ...
  {
    // Stat-clone of the Cinderhound.
    id: 'magma-crawler',
    name: 'Magma Crawler',
    intro: 'A Magma Crawler drags a wake of embers.',
    level: 10,
    rank: 'normal',
    hp: 430,
    swingTicks: 34,
  ...
  {
    // Stat-clone of the Bone Sentinel.
    id: 'null-watcher',
    name: 'Null Watcher',
    intro: 'A Null Watcher opens an eye that is not there.',
    level: 14,
    rank: 'normal',
    hp: 600,
    swingTicks: 52,
